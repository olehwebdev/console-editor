...
src/
  ...
  main/
    ...
    inspector/       InspectorService/ (the page stack: each frame's libraries, looked at once it loads), the page-side
                     detector and React hook stand-in, and the checks on what the page answers (§6.12)
  ...
  renderer/src/      React UI, Feature-Sliced Design (see DESIGN_SYSTEM.md §6):
    ...
    features/        open-resource (also original sources and the jumps between them and bundles), save-override,
                     ...
                     inspect/ (a group: stack, the Page stack)
...
- Component inspector ([research](INSPECTOR_RESEARCH.md)): ✅ the page stack, which UI library, framework, state library and bundler each frame runs (§6.12). Still to come: the component and source file behind an element (production builds too, through source maps), and how data reaches it and why it re-renders.
