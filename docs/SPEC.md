...
- **Commands:** the app menu belongs to both windows. Editor commands (the palette, the sidebar, save, …) bring the editor window forward first when the website window has focus; **Focus Address Bar** goes to the window showing the website; reload and DevTools act on the page wherever it is. Permission prompts and pop-ups are parented to the window showing the website.
