...
**Iframes and workers too.** Same-site, cross-site (out-of-process) and nested iframes, each set up before it is allowed to load anything. What Web Workers, shared workers, service workers and worklets load gets your overrides too, a service worker's own script included.
