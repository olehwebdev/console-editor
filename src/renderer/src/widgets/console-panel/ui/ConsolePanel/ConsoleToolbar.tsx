  ...
  return (
    <div className="flex shrink-0 flex-col border-b border-line">
      <div className="flex h-9 items-center gap-1.5 px-2">
        {/* The level summary and the filter give way first; then the heading (the pane's tabs) scrolls sideways. */}
        <div className="flex h-full min-w-0 flex-auto items-center">{heading ?? <span className="label-caps">Console</span>}</div>
        <LevelMenu />
        <Input
          size="sm"
          value={text}
          ...
          className="w-32 min-w-20 shrink-[100]"
        />
