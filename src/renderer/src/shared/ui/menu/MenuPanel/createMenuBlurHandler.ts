...
/** The panel's `onBlur`: focus moving outside the menu (and its trigger) closes it. */
export function createMenuBlurHandler({ isPresent, panelRef, ignoreRef, onClose, live, blurCheck }: MenuBlurContext) {
