...
export class PageController {
  ...
  /** The site's icon as a small data URL (see `fetchSiteFavicon`). */
  ...
  capture(): Promise<string | null> {
    return this.state().url && this.view.getBounds().width > 0 ? snapshotPage(this.view.webContents) : Promise.resolve(null);
  }
