...
export class PageController {
  ...
  constructor(
    ...
    this.frames = new FrameServices(() => this.settings.get(), (event) => this.send(event));
    this.engine = interceptPage(transport, this.frames, { store, rules, settings, send, siteSession: this.siteSession });
