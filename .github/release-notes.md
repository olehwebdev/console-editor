...
The disk images, the Windows installers and the `.deb` packages were each installed and tested on a machine of their architecture before this release was drafted.
