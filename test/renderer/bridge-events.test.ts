...
describe('app event bridge', () => {
  ...
  it('shows the preview when the website comes back from its own window, and only then', () => {
    ...
    pageCommands.current = { focusAddressBar: vi.fn(), togglePalette: vi.fn(), toggleSidebar: vi.fn(), toggleConsole: vi.fn(), showPreview, showInspect: vi.fn(), showRenders: vi.fn() };
...
describe('menu commands', () => {
  ...
  const page = { focusAddressBar: vi.fn(), togglePalette: vi.fn(), toggleSidebar: vi.fn(), toggleConsole: vi.fn(), showPreview: vi.fn(), showInspect: vi.fn(), showRenders: vi.fn() };
