...
import { CHANGELOG_FILE, changelogSection, VERSION_TAG_PREFIX } from '../src/shared/changelog/index.ts';
...
const section = changelogSection(readFileSync(join(root, CHANGELOG_FILE), 'utf8'), version);
if (!section?.body) {
